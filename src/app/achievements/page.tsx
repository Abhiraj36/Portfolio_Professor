        ...
        <section className="grid gap-8 sm:grid-cols-2">
          ...
          <div className="bg-gray-800 rounded-lg p-6 shadow-lg space-y-4">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-xl font-semibold text-white">Professional Journey</h2>
            </div>
            <ul className="list-disc list-inside text-gray-400 space-y-2">
          ...
          <div className="bg-gray-800 rounded-lg p-6 shadow-lg space-y-4">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-xl font-semibold text-white">Research Contributions</h2>
            </div>
            <ul className="list-disc list-inside text-gray-400 space-y-2">
              ...
              <li>Google Scholar: <strong className="text-white">754 citations, h-index 8</strong>.</li>
            </ul>
          </div>
          ...
          <div className="bg-gray-800 rounded-lg p-6 shadow-lg space-y-4">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-xl font-semibold text-white">Recognition & Leadership</h2>
            </div>
            <ul className="list-disc list-inside text-gray-400 space-y-2">
