...
export default function AchievementsPage() {
  return (
    <main className="min-h-screen animated-gradient bg-gradient-to-br from-purple-100 via-blue-100 to-pink-100 dark:from-black dark:via-gray-900 dark:to-gray-800 text-slate-900 dark:text-gray-100 px-6 py-16 transition-colors duration-300">
        ...
        <section className="grid gap-8 sm:grid-cols-2">
          ...
          <div className="bg-white dark:bg-gray-800 border border-slate-200 dark:border-gray-700 rounded-lg p-6 shadow-sm hover:shadow-md transition-all space-y-4">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-xl font-semibold">Academic Excellence</h2>
            </div>
          ...
          <div className="bg-white dark:bg-gray-800 border border-slate-200 dark:border-gray-700 rounded-lg p-6 shadow-sm hover:shadow-md transition-all space-y-4">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-xl font-semibold">Recognition & Leadership</h2>
            </div>
            <ul className="list-disc list-inside space-y-2">
